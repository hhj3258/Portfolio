...
<img src="https://user-images.githubusercontent.com/70702088/117242895-21690400-ae71-11eb-938b-03178c861bcc.png" width="25%" height="25%" title="px(픽셀) 크기 설정" alt="RubberDuck"></img>
...
- Unity VR 게임 개발 경험   
- Animation기능을 활용 가능
- coroutine의 대한 이해와 활용 가능
- reference타입과 value타입의 이해와 활용 가능
- WindowForm 프로그램 개발 경험
- PDF와 EXCEL 라이브러리 활용을 통한 파싱 프로그램 개발 경험

**C++**
- UE4 C++ 기반 프로그래밍 기본적 이해
- 객체 지향에 대한 이해 및 설계 가능
- 포인터에 대한 이해 및 활용 가능
- STL 활용 가능
...
아래 교과목들을 이수했습니다.
- 알고리즘
  - 퀵 정렬, 힙 정렬, BFS, DFS, 탐욕법 등의 알고리즘 이해
  - 시간복잡도, 점근적 표기법에 대한 이해
- 자료구조
- 컴퓨터구조
- 컴파일러구성
